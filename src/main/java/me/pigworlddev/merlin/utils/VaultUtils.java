package me.pigworlddev.merlin.utils;
...
public class VaultUtils {
    ...
    public static void storeItems(List<ItemStack> items, Player p) {
        ...
        if (items.size() == 0) {
            ...
            try {
                ...
                data.set(new NamespacedKey(Merlin.getPlugin(), "vault"), PersistentDataType.STRING, encodedData);
                os.close();

            } catch (IOException ex) {
                System.err.println("[Merlin Error Handler] " + ex);
            }
    ...
    public static ArrayList<ItemStack> getItems(Player p) {
        ...
        String encodedItems = data.get(new NamespacedKey(Merlin.getPlugin(), "vault"), PersistentDataType.STRING);
